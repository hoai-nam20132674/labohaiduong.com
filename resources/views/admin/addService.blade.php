...
@section('content')
	<div class="page-content ">
	    <ol class="breadcrumb">
	        ...
	        <li class="breadcrumb-item active">Thêm dịch vụ mới</li>
	    </ol>


                    <div class="clearfix"></div>
                    <div id="main">
                        <form method="POST" action="{{URL::route('postAddService')}}" enctype="multipart/form-data" accept-charset="UTF-8" id="form_1aa3f76ebce588e61c3b18ff42edfa1a">
                ...
                <div class="main-form">
                    <div class="form-body">
                        ...
                        <div class="form-group"  >
                            ...
                            <textarea class="form-control" rows="4" placeholder="Nội dung" data-counter="100000" name="content" cols="50" id="content">{{old('url')}}</textarea>
